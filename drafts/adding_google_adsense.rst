I've already got an adsense account from the youtube account. Apparently there's some additional checks that need to go into place. I'm following the instructions here:
